...
<head>
    ...
    <meta name="author" content="">
	 ...
	 <title>Alta exitosa del elemento</title>
  ...
  <body>
		...
		<div class="cuerpo">
			...
			<div class="alert alert-success" role="alert">
			   ...
			   <p>Id: <%=((Elemento)request.getAttribute("elemento")).getId_elemento()%></p>
				<p>Nombre: <%=((Elemento)request.getAttribute("elemento")).getNombre()%></p>
				<p>Tipo: <%=((Elemento)request.getAttribute("elemento")).getTipo_Elemento().getNombre()%></p>	
